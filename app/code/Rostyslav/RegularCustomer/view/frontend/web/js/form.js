define([
    ...
    $.widget('RostyslavRegularCustomer.form', {
        options: {
            action: '',
            productName: ''
        },
        ...
        _create: function () {
            ...
            $(document).on('rostyslav_discount_form_open', this.openModal.bind(this));
            $(this.element).on('submit.rostyslav_discount_form', this.sendRequest.bind(this));
        },
    ...
    return $.RostyslavRegularCustomer.form;
});
